...
# This is another (more holistic) solution for question no. 4 itself. You may the Ignore the follwoing block of code; This function too calculates the ratings, but using a conventional approach;However this one finds the top5 for each and every movie; things are not hard coded in this code
```{r fig.width=7, fig.height=6}
